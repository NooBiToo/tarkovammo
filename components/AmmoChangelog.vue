<template>
  <div class="changelog">
    <div class="changelog__title" @click="isHidden = !isHidden">
      Updates
      <div class="question-icon"></div>
    </div>
    <div v-if="!isHidden" class="changelog__wrap">
      <div v-for="(update, index) in updates" :key="index" class="changelog__commit" >
        <p class="changelog__date">{{update.gsx$дата.$t}}</p>
        <p v-html="handleNewLine(update.gsx$описание.$t)">
        </p>
      </div>
    </div>
  </div>
